			...
			switch (status) {
				...
				case SpeechToTextStatus.Recognizing:
					if (text) {
						...
						dictationState = applyDictationInputState(dictationState, controller.getInput(), text, status);
...
export function applyDictationInputState(
	...
	// User edits are authoritative; treat them as new base for upcoming speech composition.
